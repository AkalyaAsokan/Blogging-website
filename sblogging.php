...
session_start();
	...
	{?>
		...
		<a href="profile.html"><img src="update.png" style="width:30px;height:30px;"></a>&nbsp
...
<?php
  ...
  $query = "INSERT INTO bloggers VALUES ('$name','$email','$pwd')";
...
*/  $query="Select name,img_name from new order by time desc";
  $result=mysqli_query($con,$query);
  ...
  echo '<h1>MySQL Server is not connected</h1>';
	...
	<div id="id04" class="modal">
		<span onclick="document.getElementById('id04').style.display='none'" class="close" title="Close">×</span>
			<div class="place" style="background:url(mic.png);background-size:200px 400px; margin-left:800px;margin-top:100px;">
			<br><br><br><br><br><br><br><br><br><br>
			</div><br>
			<div class="forform">
